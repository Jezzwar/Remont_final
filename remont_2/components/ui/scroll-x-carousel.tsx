...
function useScrollXCarousel() {
  ...
  if (!context) throw new Error('useScrollXCarousel must be used within a ScrollXCarousel');
  return context;
}

export function ScrollXCarousel({ children, className, ...props }: React.HTMLAttributes<HTMLDivElement>) {
